...
class RegistrasiApp:
    ...
    def buat_interface(self):
        ...
        # Lakukan validasi awal agar indikator umur langsung sesuai
        try:
            self.validate_age()
        except Exception:
            pass
    ...
    def buat_input_field(self, parent, label_text, variable, field_name, hint_text, show=None):
        """Membuat input field dengan indikator validasi"""
    ...
    def validate_agreement(self):
        self.validation_status['agree'] = bool(self.agree_var.get())
        self.update_submit_button()
